...
class LlavaForEdit(BaseVLLMForEdit):
    ...
    def get_llm_outpt(self, llm_inpt, vt_range = None):
        ...
        outpt = self.model.language_model(**llm_inpt, output_attentions=True, use_cache = False) # It's necessary to set output_attentions=True to get attention_mask. Please refer to LLamaForCausalLM.forward.
        return outpt
