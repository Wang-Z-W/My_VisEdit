...
def get_attr():
    ...
    parser.add_argument('-spt', '--split', type=str, default='train', help = 'Train split.')
...
if __name__ == '__main__':
    ...
    if cfg.data_name == 'EVQA':
        ...
        raise BaseException("Not support dataset.")
    # initialize and train
    editor.train_init(train_data, cfg.data_name, cfg.batch_size, train_name_prefix = cfg.train_name_prefix,
