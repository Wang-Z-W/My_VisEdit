...
class VLLMBaseEditorWithTraining(VLLMBaseEditor):
    ...
    def train_init(self, vllm_edit_data:BaseVLLMEditData, data_name:str, batch_size:int, 
        ...
        '''Used to initialize:
            data generator `self.data_generator`,
            checkpoint/log 
            directory,
            writer,
            and optimizer. '''
        ...
        records_dir = os.path.join(records_dir, *self.name_of_editor_and_model(), data_name, train_name)
