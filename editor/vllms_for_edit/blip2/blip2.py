...
class BLIP2OPTForEdit(BaseVLLMForEdit):
    '''For blip2-opt 2.7b'''
    def __init__(self, model_path:str, device = 'cuda', max_memory = None) -> None:
        from transformers import Blip2Processor, Blip2ForConditionalGeneration
        self.model = Blip2ForConditionalGeneration.from_pretrained(
            model_path,
            device_map = "auto",
            revision = "235c75ea3861136b9dd202c6edc6a7ba285c35e3",
            max_memory = max_memory
        )
        self.processor = Blip2Processor.from_pretrained(model_path, revision="235c75ea3861136b9dd202c6edc6a7ba285c35e3")
